...
struct static_iterator
{
	...
	static constexpr int Rank = index_type::rank;
};
...
struct static_view
{
	...
	static constexpr int Rank = BeginIter::rank;
	...
	private : celerity::buffer<value_type, rank> buffer_;
...
template <template <typename, size_t> typename Buffer, typename T, int Rank, size_t... Ids>
...
template <template <typename, size_t> typename Buffer, typename T, int Rank>
