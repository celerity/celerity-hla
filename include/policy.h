...
{
	using kernel_name = typename celerity::hla::traits::policy_traits<T>::kernel_name;
};
...
using indexed_kernel_name_t = typename celerity::hla::traits::policy_traits<typename indexed_kernel_name<Policy>::type>::kernel_name;
