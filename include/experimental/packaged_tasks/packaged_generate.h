#ifndef CELERITY_HLA_PACKAGED_GENERATE_H
#define CELERITY_HLA_PACKAGED_GENERATE_H
...
namespace celerity::hla::traits
{
    ...
    struct is_packaged_task<celerity::hla::experimental::detail::packaged_generate<FunctorType, InputValueType, OutputIteratorType, Rank>>
        : std::true_type
    {
    };

    template <typename FunctorType, typename InputValueType, int Rank>
    struct is_partially_packaged_task<celerity::hla::experimental::detail::partially_packaged_generate<FunctorType, InputValueType, Rank>>
        : std::true_type
    {
    };

    template <typename FunctorType, typename OutputValueType, typename OutputIteratorType, int Rank>
    struct packaged_task_traits<celerity::hla::experimental::detail::packaged_generate<FunctorType, OutputValueType, OutputIteratorType, Rank>>
    {
    ...
    template <typename FunctorType, typename OutputValueType, int Rank>
    struct packaged_task_traits<celerity::hla::experimental::detail::partially_packaged_generate<FunctorType, OutputValueType, Rank>>
    {
        static constexpr auto rank = Rank;
        static constexpr auto computation_type = detail::computation_type::generate;
    ...
    template <typename FunctorType, typename OutputValueType, int Rank>
    struct partially_packaged_task_traits<celerity::hla::experimental::detail::partially_packaged_generate<FunctorType, OutputValueType, Rank>>
