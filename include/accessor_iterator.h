...
{
    template <typename AllType, int Rank>
    struct iterator_traits<celerity::hla::all_iterator<AllType, Rank>>
    {
    ...
    template <typename SliceType>
    struct iterator_traits<celerity::hla::slice_iterator<SliceType>>
    {
        using difference_type = long;
    ...
    template <typename ChunkType, int Rank>
    struct iterator_traits<celerity::hla::chunk_iterator<ChunkType, Rank>>
    {
        using difference_type = long;
